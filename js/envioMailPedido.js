...
function envioPedidoMailCliente() {
  ...
  let body = nombre.value + "<br><br>" + "  Su orden N° "+ sessionStorage.getItem('numeroPedido') + " esta siendo preparada, le avisaremos cuando este en camino." +  "<br><br>" + "Saludos Hamburguesria Visual!!"
